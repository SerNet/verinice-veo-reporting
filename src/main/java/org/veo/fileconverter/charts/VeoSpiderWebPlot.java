...
public class VeoSpiderWebPlot extends Plot implements Cloneable {
   ...
   */
  public VeoSpiderWebPlot(CategoryDataset dataset) {
   ...
   */
  public VeoSpiderWebPlot(CategoryDataset dataset, TableOrder extract) {
    super();
  ...
  /**
   * Sets the paint for ALL series in the plot. If this is set to {@code null}, then a list of
   * paints is used instead (to allow different colors to be used for each series of the radar
   * group).
   *
  ...
  /**
   * Sets the outline paint for ALL series in the plot. If this is set to {@code null}, then a list
   * of paints is used instead (to allow different colors to be used for each series).
   *
   * @param paint the paint ({@code null} permitted).
   */
  ...
  /**
   * Sets the outline stroke for ALL series in the plot. If this is set to {@code null}, then a list
   * of paints is used instead (to allow different colors to be used for each series).
   *
