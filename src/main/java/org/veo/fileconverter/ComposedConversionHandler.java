...
/**
 * A conversion handler that delegates to a pair of conversion handlers A and B to support direct
 * conversion from A's input format to B's output format by applying them one after another.
 */
