...
dependencies {
    ...
    implementation("io.github.openhtmltopdf:openhtmltopdf-slf4j:1.1.73")
    implementation("io.github.openhtmltopdf:openhtmltopdf-objects:1.1.73")
...
jib {
    from {
        image = "gcr.io/distroless/java25-debian13:nonroot@sha256:54bb9e269b6f1866d91055fd55dc39baee1914da01bb03eeb44c5b268e77176a"
    }
    container {
        labels.set(
            project.provider {
