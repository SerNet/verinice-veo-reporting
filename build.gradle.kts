...
dependencies {
    ...
    implementation("io.github.openhtmltopdf:openhtmltopdf-core:1.1.78")
    implementation("io.github.openhtmltopdf:openhtmltopdf-pdfbox:1.1.78")
    implementation("io.github.openhtmltopdf:openhtmltopdf-slf4j:1.1.78")
    implementation("io.github.openhtmltopdf:openhtmltopdf-objects:1.1.78")
    implementation("io.github.openhtmltopdf:openhtmltopdf-svg-support:1.1.78")
...
jib {
    from {
        image = "gcr.io/distroless/java25-debian13:nonroot@sha256:634fedd0558a9c4a9fd74e56b7285f3144e643d5a0c02508025489878aba913b"
    }
    container {
        labels.set(
            project.provider {
