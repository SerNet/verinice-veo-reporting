...
dependencies {
    ...
    implementation("io.github.openhtmltopdf:openhtmltopdf-slf4j:1.1.40")
    implementation("io.github.openhtmltopdf:openhtmltopdf-objects:1.1.40")
...
jib {
    from {
        image = "gcr.io/distroless/java25-debian13:nonroot@sha256:4a1982383b6f66a32ee1e1c9dd7b0e171b44553c72da6045e874c70cc3c24413"
    }
    container {
        labels.set(
            project.provider {
