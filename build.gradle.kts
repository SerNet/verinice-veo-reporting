...
dependencies {
    ...
    implementation("io.github.openhtmltopdf:openhtmltopdf-slf4j:1.1.82")
    implementation("io.github.openhtmltopdf:openhtmltopdf-objects:1.1.82")
    implementation("io.github.openhtmltopdf:openhtmltopdf-svg-support:1.1.82")
