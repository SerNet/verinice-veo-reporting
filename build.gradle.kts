...
dependencies {
    ...
    implementation("io.github.openhtmltopdf:openhtmltopdf-core:1.1.58")
    implementation("io.github.openhtmltopdf:openhtmltopdf-pdfbox:1.1.58")
    implementation("io.github.openhtmltopdf:openhtmltopdf-slf4j:1.1.58")
    implementation("io.github.openhtmltopdf:openhtmltopdf-objects:1.1.58")
...
jib {
    from {
        image = "gcr.io/distroless/java25-debian13:nonroot@sha256:9ccf2b8bce700d9f450523e2055afabe4d4ee795e6d69a0647a2dcd6e180e411"
    }
    container {
        labels.set(
            project.provider {
