...
dependencies {
    ...
    implementation("io.github.openhtmltopdf:openhtmltopdf-core:1.1.84")
    implementation("io.github.openhtmltopdf:openhtmltopdf-pdfbox:1.1.84")
    implementation("io.github.openhtmltopdf:openhtmltopdf-slf4j:1.1.84")
    implementation("io.github.openhtmltopdf:openhtmltopdf-objects:1.1.84")
    implementation("io.github.openhtmltopdf:openhtmltopdf-svg-support:1.1.84")
...
jib {
    from {
        image = "gcr.io/distroless/java25-debian13:nonroot@sha256:fce4a1d66284e8866c46113d9bdc286c46fb8c3c3f0a098f877034349e88debe"
    }
    container {
        labels.set(
            project.provider {
